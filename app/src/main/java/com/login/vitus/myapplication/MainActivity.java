package com.login.vitus.myapplication;
...
//
//        //seattle coordinates
//        LatLng seattle = new LatLng(19.1754139, 72.9449622);
//        mMap.setMinZoomPreference(10);
//        mMap.setMaxZoomPreference(20);
//        mMap.addMarker(new MarkerOptions().position(seattle).title("Joy's"));
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.setOnMapClickListener(new GoogleMap.OnMapClickListener() {
            ...
            public void onMapClick(LatLng latLng) {
                addLocationAlert(latLng.latitude, latLng.longitude);//Book me in-> location(19.1071277,72.8825685); //(latLng.latitude, latLng.longitude);
            }
        });
    }
